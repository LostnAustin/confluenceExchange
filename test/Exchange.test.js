    ...
    contract('Exchange', ([deployer, feeAccount, user1, user2]) => {
       ...
       const feePercent = 10
        ...
        beforeEach(async () => {
            ...
            // transfer test tokens to user 1
        ...
        describe('depositing tokens', () => {
            ...
            describe('failure', () => {
                //ETH stored in a separate wallet from exchange, so prevent ETH depositis
        ...
        describe('withdrawing tokens', async () => {
            ...
            describe('failure', async () => {
                it('rejects Ether withdraws', async () => {
                    //try withdrawing ETH without having deposited any first
                    await exchange.withdrawToken(ETHER_ADDRESS, tokens(10), { from: user1 }).should.be.rejectedWith(EVM_REVERT)
                })

                it('fails for insufficient balances', async () => {
                    //try withdrawing tokens without having deposited any first
        ...
        describe('order actions', async () => {
            ...
            beforeEach(async () => {
                ...
                // user1 makes a buy order for tokens with ETH
                    ...
                    describe('success', async () => {   
                        ...
                        describe('failure', async () => {
                            ...
                            it('rejects unauthorized cancellations', async () => {
                                // attempt to cancel order from another user
